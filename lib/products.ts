...
export const PRODUCTS: Product[] = [
  {
    ...
    features: ["Kernel-level HWID spoofing", "Motherboard serial replacement", "GPU UUID reset", "Disk signature change", "Network adapter MAC reset", "Survives all reboots permanently", "EAC, BattleEye, Vanguard, Ricochet", "Intel + AMD supported", "Setup under 5 minutes", "Unique hardware profile per user", "Lifetime Discord support"],
  ...
  },
  {
    ...
    longDescription: "Session-based HWID spoofing with zero permanent changes. Activates on boot, clears on restart. Ideal for alt accounts and short-term protection.",
    features: ["Session-based HWID spoofing", "Zero permanent system changes", "Activates on boot, clears on restart", "Works after HWID ban", "EAC, BattleEye, Vanguard compatible", "Instant activation", "Clean session isolation", "3 minute setup", "Discord support included"],
  ...
  },
  {
    ...
    longDescription: "Runs completely outside the game process — no injection, no kernel driver, no second PC. Clean overlay with zero FPS impact.",
    features: ["No DMA hardware required", "No injection, no kernel driver", "No dual-PC needed", "Zero FPS impact", "Smooth aimbot", "Full player ESP", "Stream-safe", "100% Tournament safe", "Sub-2h patch response"],
  ...
  },
  {
    ...
    longDescription: "Lightweight DMA cheat for clean performance at an accessible price. Core ESP and aimbot, fast patch updates, instant delivery.",
    features: ["Full player ESP", "Smooth aimbot", "No recoil", "EAC / BattleEye bypass", "Fortnite + Apex Legends", "Fast patch updates", "Instant delivery"],
  ...
  },
  {
    ...
    features: ["Full player ESP", "Smooth aimbot + triggerbot", "Full map radar", "No recoil", "Stream-proof overlay", "EAC, BE, FaceIt, Vanguard, Ricochet", "UAV radar overlay", "Web radar", "Web menu", "Loot ESP", "Auto updater sub-2h", "6 games supported"],
    image: "/images/products/blurred-dma.png",
    category: "cheat",
    badge: "Popular",
    popular: true,
  ...
  },
  {
    ...
    features: [
      "Captain DMA 100T-7th card",
      "Mini DP Fuser V2",
      "EAC / BattlEye emulated firmware",
      "Blurred DMA Cheat (30 Days)",
      "Macku included free",
      "Pre-configured & ready to use",
      "Ships within 24 hours",
      "Lifetime Discord support",
    ],
  },
  {
    id: "dma-advanced",
    ...
    features: [
      "Captain DMA 100T-7th card",
      "Dichen D60 Fuser",
      "Teensy with firmware included",
      "EAC / BattlEye emulated slotted firmware",
      "Blurred DMA Cheat (Quarterly)",
      "Slotted firmware — reduced detection overlap",
      "Pre-configured & ready to use",
      "Ships within 24 hours",
  ...
  },
  {
    ...
    features: [
      ...
      "Dichen DC500 Fuser",
      "Teensy with firmware included",
      "EAC / BattlEye / FaceIt / Vanguard emulated",
      "Blurred DMA Cheat (Lifetime)",
      "Full anti-cheat emulation stack",
