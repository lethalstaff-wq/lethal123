  ...
  return (
    <section id="products" className="py-24 px-6 sm:px-10 relative z-10">
      ...
      <style jsx>{`
        ...
        .about-card:hover { background: rgba(255,255,255,0.04); border-color: rgba(249, 115, 22, 0.55); box-shadow: 0 24px 48px rgba(0,0,0,0.5), 0 0 50px rgba(249, 115, 22, 0.2); }
