...
export function CookieConsent() {
  ...
  return (
    <div className={`fixed bottom-20 md:bottom-6 right-6 z-[80] max-w-sm transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}>
      <div className="relative rounded-2xl border border-white/[0.10] bg-black/90 backdrop-blur-xl shadow-[0_24px_60px_rgba(0,0,0,0.55),0_0_40px_rgba(249,115,22,0.10)] p-5 overflow-hidden">
        ...
        <div className="flex items-start gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#f97316]/25 to-[#ea580c]/15 border border-[#f97316]/30 flex items-center justify-center shrink-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_18px_rgba(249,115,22,0.18)]">
            <Shield className="h-[18px] w-[18px] text-[#f97316]" style={{ filter: "drop-shadow(0 0 8px rgba(249,115,22,0.5))" }} />
          </div>
        ...
        <div className="flex gap-2">
          <button
            onClick={accept}
            className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-br from-[#f97316] to-[#ea580c] text-white text-[12px] font-bold hover:brightness-110 hover:scale-[1.02] transition-all shadow-[0_4px_14px_rgba(249,115,22,0.32),inset_0_1px_0_rgba(255,255,255,0.08)]"
          >
            Accept All
          </button>
          <button
