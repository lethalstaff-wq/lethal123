        ...
        <DialogContent className="max-w-2xl">
          ...
          <ScrollArea className="h-[60vh] pr-4">
            <div className="space-y-4 text-sm text-white/55">
              <section>
                <h3 className="font-bold text-white mb-2">1. No Refunds Policy</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">2. Virtual Goods</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">3. Account Safety</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">4. Usage Terms</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">5. Limitation of Liability</h3>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <ScrollArea className="h-[60vh] pr-4">
            <div className="space-y-4 text-sm text-white/55">
              ...
              <section>
                <h3 className="font-bold text-white mb-2">2. Data Privacy</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">3. Cookies & Tracking</h3>
              ...
              <section>
                <h3 className="font-bold text-white mb-2">4. GDPR Compliance</h3>
