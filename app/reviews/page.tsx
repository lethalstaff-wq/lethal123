...
export default function ReviewsPage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col bg-black">
      ...
      <Navbar />
      <section className="relative z-[2] flex-1 py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-white/[0.06] bg-white/[0.02]">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/40">Reviews</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 tracking-[-0.03em] text-white">
              Customer <span style={{ background: "linear-gradient(135deg, #f97316, #fb923c)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Reviews</span>
            </h1>
